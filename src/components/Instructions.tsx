  ...
  return (
    <div className="instructions-container slide-up" style={{ animationDelay: '0.5s' }}>
      ...
      <ol className="instructions-list">
        ...
        <li><strong>Reset Round</strong> (Easy only) shuffles the pick order — keeps Friday pts and lives, skips re-entering Friday pts on each pick</li>
        ...
        <li>At <strong>100%</strong> progress in Easy mode, <strong>Pick Student</strong> is blocked — use one of the reset buttons to continue</li>
      </ol>
    </div>
  );
};
